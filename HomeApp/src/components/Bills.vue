<template>
    <div class="row q-ma-xl justify-center">
      <q-chip avatar="assets/rent.svg" color="pink" text-color="white" class="text-bold q-ma-xs shadow-4">$400</q-chip>
      ...
      <q-chip avatar="assets/bolt-solid.svg" color="black" text-color="yellow" class="text-bold q-ma-xs shadow-4">$69</q-chip>
