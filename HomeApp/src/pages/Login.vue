  ...
  <div class="splash page flex row content-center justify-center text-center">
    ...
    <div class="col-10 q-mx-xl">
        <div class="q-mt-xs buttons row justify-center">
          <q-input class="q-ma-md col-12" v-model="email" type="email" float-label="Email" />
          <q-input class="q-ma-md col-12" v-model="password" type="password" float-label="password" no-pass-toggle />
